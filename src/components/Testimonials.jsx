...
export default function TestimonialCarousel() {
  ...
  return (
    <div
      className="relative text-white py-20 px-6 md:px-24 bg-cover bg-center"
      style={{ backgroundImage: "url('/assets/background5.jpg')" }}
    >
      <div className="absolute inset-0 bg-black/90 z-0" />

      <div className="relative z-10 text-center mb-12">
        <h2 className="text-3xl md:text-5xl font-bold font-[Inter]">WHAT OUR CLIENTS SAY</h2>
      ...
      <div className="relative z-10 flex flex-col md:flex-row gap-10 items-center justify-center">
        {/* Testimonial Box */}
        <div className="bg-gradient-to-l from-[#222] to-black p-8 rounded-lg shadow-xl max-w-xl w-full">
          ...
          <div className="absolute bottom-6 right-6 flex space-x-2 mt-4">
